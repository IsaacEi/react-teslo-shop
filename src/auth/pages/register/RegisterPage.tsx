...
export const RegisterPage: FC = () => {
  ...
  const handleRegister = async ( event: FormEvent<HTMLFormElement> ) => {
    ...
    const isLoggedIn = await register( { email, password, fullName } );
  ...
  return (
    <div className={"flex flex-col gap-6"}>
          ...
          <form className="p-6 md:p-8" onSubmit={ handleRegister }>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <CustomLogo />
                <p className="text-balance text-muted-foreground">Regístrese en nuestra aplicación</p>
              </div>
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        Al hacer clic en continuar, aceptas nuestros <Link to="#">Términos de Servicio</Link> y <Link to="#">Política de Privacidad</Link>.
      </div>
    </div>
  )
}
